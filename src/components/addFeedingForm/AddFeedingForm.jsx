            ...
            <form onSubmit={handleFeedingFormSubmit}>
               <label>Feeding Form</label>
                <fieldset>
                    ...
                    <select onChange={handleCatSelectChange} name="cat_name" id="cat_name" aria-label="Cat name selector" required>
                ...
                <fieldset>
                    ...
                    <input type="text" name="feeder_username" id="feeder_username" value={username} aria-label="Feeder Username, Read Only" readOnly required></input>
                </fieldset>
                {medsNeeded && <fieldset>
                   <p>Medication Given?</p>
                   <p></p>
                    <input type="radio" name="medication_given" id="medication_given" aria-label="Medication Given 'Yes' button" required></input>
                    <label>Yes</label>
                    <input type="radio" name="medication_given" id="medication_given" aria-label="Medication Given 'No' button" required></input>
                    <label>No</label>
                </fieldset>}
                <fieldset>
                    <label htmlFor="time">Feed Time </label>
                    <input type="time" name="time" id="time" aria-label="Feeding Time Input"  required></input>
                </fieldset>
                <fieldset>
                    <label htmlFor="notes">Notes </label>
                    <textarea name="notes" id="notes" aria-label="Notes text input"></textarea> 
                </fieldset>
